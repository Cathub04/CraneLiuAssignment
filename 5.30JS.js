...
function menu(){
  ...
  document.getElementById('foods').innerHTML='Here is your order:'+ fd[choice1] +', '+ fd[choice2] +' '+'and'+' '+ fd[choice3] +'. '+'The total price is $'+ rslt +'. Your meal will be waiting you on the day of'+' '+dy+'.'
}
